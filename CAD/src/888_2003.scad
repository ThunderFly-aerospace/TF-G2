...
module 888_1011(){
    ...
    hubDiameter          = 8;    // The diameter of the hub portion of the wheel
    hubHeight            = wheelWidth;    // The total height of the hub
    hubZOffset           = 00;     // The Z position of the hub, negative numbers from the surface of the wheel
    innerCircleDiameter  = 10;    // The diameter of the solid inner circle under the hub, or zero for none.

    baseFilletRadius     = 1;     // The radius of the fillet (rounded part) between the hub and wheel.
    ...
    shaftDiameter        = 3.3+0.4;          // The diameter of the motor shaft
    shaftFlatDiameter    = 3.3+0.4;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
