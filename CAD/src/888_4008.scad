                    ...
                    {    
                            union()
                            {
                                ...
                                translate([0,0,thickness/2+starter_top_h+starter_neck_h/2])
                                    cylinder(h=starter_neck_h+0.3,r=starter_neck_r,center=true, $fn=100);
                            ...
                            union()
                            {
                                translate([0,0,thickness/2+sensor_cap_height])                                
                                    cylinder(h=2*sensor_cap_height,r=starter_pipe_r,center=true, $fn=100);
                                
                                translate([0,0,thickness/2+starter_top_h+starter_bottom_h+starter_neck_h+rpm_sensor_h])                                
                                    cylinder(h=2*rpm_sensor_h,r=rpm_sensor_inner_r,center=true, $fn=100);
