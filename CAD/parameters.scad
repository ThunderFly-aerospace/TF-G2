...
base_split_position = [0, 145, base_length];
...
mount_tube_out_d=10.0; // landing gear mount tube outer diameter
skid_tube_d=6.0;  // landing gear skid tube outer diameter
